...
var DryFurnace = function (_Component) {
  _inherits(DryFurnace, _Component);

  function DryFurnace() {
    _classCallCheck(this, DryFurnace);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  DryFurnace.prototype.render = function render() {
...
DryFurnace.propTypes = process.env.NODE_ENV !== "production" ? {
