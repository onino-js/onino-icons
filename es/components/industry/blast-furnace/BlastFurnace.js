...
var BlastFurnace = function (_Component) {
  _inherits(BlastFurnace, _Component);

  function BlastFurnace() {
    _classCallCheck(this, BlastFurnace);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  BlastFurnace.prototype.render = function render() {
...
BlastFurnace.propTypes = process.env.NODE_ENV !== "production" ? {
